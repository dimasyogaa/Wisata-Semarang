package com.yogadimas.wisatasemarang.view.education;
...
public class EducationActivity extends AppCompatActivity {
    ...
    public ArrayList<Tours> getListTours() {
        ...
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_education_picture);
        String[] dataId = getResources().getStringArray(R.array.data_education_id);
        String[] dataName = getResources().getStringArray(R.array.data_education_name);
        String[] dataDescription = getResources().getStringArray(R.array.data_education_description);
